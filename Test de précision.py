...
# plt.grid()
# plt.legend()
# plt.title('Explicite décentré amont')
# plt.show()
...
# plt.grid()
# plt.legend()
# plt.title('Implicite décentré amont')
# plt.show()
...
# plt.grid()
# plt.legend()
# plt.title('Crank-Nicolson centré')
# plt.show()
...
# plt.grid()
# plt.legend()
# plt.title('Crank-Nicolson décentré amont')
# plt.show()


### Calcul des erreurs

ErrEc = np.max(np.abs(Ucn[-1, :] - Ue[-1, :]))
ErrEd = np.max(np.abs(Ucn[-1, :] - Ued[-1, :]))
ErrIc = np.max(np.abs(Ucn[-1, :] - Ui[-1, :]))
ErrId = np.max(np.abs(Ucn[-1, :] - Uid[-1, :]))
ErrCNd = np.max(np.abs(Ucn[-1, :] - U_cn[-1, :]))
